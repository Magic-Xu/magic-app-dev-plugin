...
- Each screen owns its feature Store; app state is limited to routes and cross-feature coordination.
- All quality gates are mandatory, including locale parity and the 400-line production Kotlin limit.
